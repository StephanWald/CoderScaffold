...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-08-15 — Completed quick task 260815-idj: update-coder.sh Step 5/5 host CLI alignment (auto-reinstall host coder CLI to match new server version, --no-cli-update flag)
