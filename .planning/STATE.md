...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-08-21 — Completed quick task 260821-ihu: added optional per-workspace case-insensitive project filesystem (ext4 casefold loopback) to bbj-services for the CarIT Windows codebase; opt-in params + SYS_ADMIN/privileged escape hatch, hardened against home-shadow and lost+found defects; terraform validate PASS; runtime loop-mount verification still required (live deploy)
